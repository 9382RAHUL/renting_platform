      ...
      <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", background: "#f0f1f8" }}>
        ...
        <main className="signup-main">
          ...
          <section className="signup-left">
            ...
            <div className="signup-left-content" style={{ position: "relative", zIndex: 2, padding: "56px 52px", display: "flex", flexDirection: "column", justifyContent: "center", color: "#fff", maxWidth: 520 }}>
              ...
              {/* Social Proof */}
              <div className="social-proof-section" style={{ display: "flex", alignItems: "center", gap: 12 }}>
                <div style={{ display: "flex" }}>
                  {[
                    "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=80&q=80",
                    "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=80&q=80",
          ...
          <section className="signup-right">
            ...
            <div className="signup-card" style={{ width: "100%", maxWidth: 460, background: "#fff", borderRadius: 24, boxShadow: "0 8px 40px rgba(0,0,0,0.10)", padding: "36px 40px" }}>
